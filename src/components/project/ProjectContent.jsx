...
const ProjectContent = () => {
  return (
    <div className="w-[80%] py-[50px] mx-auto">
      ...
      <div className="space-y-[30px]">
        {project.map((item, index) => {
          return (
            <div
              key={index}
              className="sm:flex sm:p-[10px] p-[30px] gap-[20px] min-h-[170px] rounded-[7px] hover:bg-white/10 duration-700"
            >
              <div className="sm:w-[30%]">
                {item.image[0] ? (
                  ...
                  >
                    ...
                    {/* ซ่อนรูปอื่นๆ ไว้ให้แสดงตอนเปิด PhotoView */}
